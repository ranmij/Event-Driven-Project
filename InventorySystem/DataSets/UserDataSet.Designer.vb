...
Namespace InventorySystem.DataSets.UserDataSetTableAdapters
    ...
    Partial Public Class usersTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(4).CommandText = "SELECT COUNT(*) FROM users WHERE username = @username"
            ...
            Me._commandCollection(5).CommandText = "SELECT COUNT(*) FROM users WHERE role_id = 1;"
